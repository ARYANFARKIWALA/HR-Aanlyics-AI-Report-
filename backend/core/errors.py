...
class AppException(Exception):
    ...
    def __init__(self, message: str, status_code: int = status.HTTP_500_INTERNAL_SERVER_ERROR, details: dict[str, Any] | None = None):
...
class SecurityError(AppException):
    ...
    def __init__(self, message: str = "Security access violation", details: dict[str, Any] | None = None):
